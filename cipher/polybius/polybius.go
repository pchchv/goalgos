...
// Reference: https://en.wikipedia.org/wiki/Polybius_square#Hybrid_Polybius_Playfair_Cipher
package polybius
...
// NewPolybius returns a pointer to a Polybius object.
// If the size of "chars" is larger than "size", "chars" is truncated to "size".
...
func (p *Polybius) Encrypt(text string) (encryptedText string, err error) {
...
func (p *Polybius) Decrypt(text string) (decryptedText string, err error) {
