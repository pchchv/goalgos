...
// Hash hashes the input message using the sha256
// hashing function and returns an array of 32 bytes.
// The implementation follows the RGC6234 standard,
// which is documented at https://datatracker.ietf.org/doc/html/rfc6234.
